...
class Scenery(scene.Scene):
    def __init__(self, add_extras: bool = True, more_extras: list[str] = None, load_cp: bool = False):
        super().__init__(add_extras=add_extras, more_extras=more_extras, load_cp=load_cp)
